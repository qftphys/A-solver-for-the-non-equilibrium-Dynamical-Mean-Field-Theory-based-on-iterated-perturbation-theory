MODULE NEQ_CONTOUR_GF
  ...
  interface deallocate_kb_contour_gf
     ...
     module procedure deallocate_kb_contour_gf_nambu
     module procedure deallocate_kb_contour_gf_nambu_redux
  ...
  interface allocate_kb_contour_sigma
     ...
     module procedure allocate_kb_contour_sigma_nambu
     module procedure allocate_kb_contour_sigma_nambu_redux
  ...
  interface deallocate_kb_contour_sigma
     ...
     module procedure deallocate_kb_contour_sigma_nambu
     module procedure deallocate_kb_contour_sigma_nambu_redux
  ...
  interface allocate_kb_contour_dgf
     ...
     module procedure allocate_kb_contour_dgf_nambu
  ...
  interface deallocate_kb_contour_dgf
     ...
     module procedure deallocate_kb_contour_dgf_nambu
     module procedure deallocate_kb_contour_dgf_nambu_redux
  ...
  public :: get_rmix
  interface get_bar
     module procedure get_bar_gf
     module procedure get_bar_sigma
  end interface get_bar
  public :: get_bar
  !
  !
  !OVERLOAD OPERATORS
